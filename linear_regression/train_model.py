...
print(df.describe())
print(df["yeild"].value_counts())  # Check for low variance
...
# Debug: Print feature mean and std
...
rf_model = RandomForestRegressor(n_estimators=100, max_depth=5, random_state=42)  # Prevent overfitting
